             ...
             @auth
                 <div class="ms-auto hidden w-full items-center justify-between md:order-2 md:flex md:w-auto"
                     ...
                     <button type="button" class="flex rounded-full bg-gray-800 text-sm focus:ring-4 focus:ring-gray-300"
                         ...
                         <img class="h-8 w-8 rounded-full object-cover" src="{{ Auth::user()->profile_picture }}"
             ...
             <ul class="space-y-2 font-medium">
                 ...
                 {{-- <li>
                     <a href="{{ route('dash') }}"
                         ...
                         <span class="text-s ms-3 flex-1 whitespace-nowrap text-sm">Dashboard View</span>
                     </a>
                 </li> --}}
                 @auth
                     <li>
                         <a href="{{ route('list.pencairan') }}"
                             ...
                             <span class="text-s ms-3 flex-1 whitespace-nowrap text-sm">Request Pencairan</span>
                         </a>
                     </li>
                     <li>
